    ...
    public String makeRequest(double lat, double lng, String keyparams)  throws IOException {
        ...
        if (networkconnected) {
            ...
            if (responseCode == 200) {
                ...
                Toast toast = Toast.makeText(ApiRequest.this, "Not submitted. Server Error.", Toast.LENGTH_LONG);
            ...
            Toast toast = Toast.makeText(ApiRequest.this, "Please check your internet connection.", Toast.LENGTH_LONG);
            LinearLayout toastLayout = (LinearLayout) toast.getView();
            TextView toastTV = (TextView) toastLayout.getChildAt(0);
            toastTV.setTextSize(15);
            toast.show();
